					...
					<div class="inside">
						...
						<section class="contact-info">
							<address>
								...
								347320, Rostov region, <br /> 
								Tsymlyansk, Lazo street, 1
							</address>
							...
							<p>
								...
								General questions: <?= safe_mailto('info@vinoigristoe.ru', 'info@vinoigristoe.ru'); ?> <br />
								Export: <?= safe_mailto('export@vinoigristoe.com', 'export@vinoigristoe.com'); ?>
							</p>
						</section>
						<div class="spline"></div>
						<div class="contact">
