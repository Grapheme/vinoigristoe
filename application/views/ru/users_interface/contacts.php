					...
					<div class="inside">
						...
						<section class="contact-info">
							<address>
								...
								347320, Ростовская область, <br /> 
								г. Цимлянск, ул.Лазо, 1
							</address>
							<div class="contacts-map cf">
								<div id="ymaps-map-id_134487107820731102958" style="width: 39.75em; height: 25em;"></div>
								<script type="text/javascript">function fid_134487107820731102958(ymaps) {var map = new ymaps.Map("ymaps-map-id_134487107820731102958", {center: [37.450962, 55.83162590207502], zoom: 14, type: "yandex#map"});map.controls.add("zoomControl").add("mapTools").add(new ymaps.control.TypeSelector(["yandex#map", "yandex#satellite", "yandex#hybrid", "yandex#publicMap"]));map.geoObjects.add(new ymaps.Placemark([37.450962, 55.830938], {balloonContent: "ОАО «Цимлянские вина»<br/>115054, г. Москва, ул. Дубининская, д. 57, корп. 2, оф. 310<br/>+7 (499) 750-01-40 "}, {preset: "twirl#darkblueDotIcon"}));};</script>
							...
							<p>
								...
								По общим вопросам: <?= safe_mailto('info@vinoigristoe.ru', 'info@vinoigristoe.ru'); ?> <br />
								Экспорт: <?= safe_mailto('export@vinoigristoe.com', 'export@vinoigristoe.com'); ?>
							</p>
						</section>
						<div class="spline"></div>
						<div class="contact">
