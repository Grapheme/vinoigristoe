	...
	<div class="container cf">
		<section class="cf">
			...
			<div class="social-widget">
				...
				<div class="fb-like-box" data-href="http://www.facebook.com/Tsimlyanskoe" data-width="218" data-height="215" data-show-faces="true" data-stream="false" data-header="false"></div>
			</div>
			<nav>
				<ul>
				...
				<p class="partners">
					Наши партнеры: <a target="_blank" href="http://www.helikon.ru"><img src="<?= $baseurl ?>images/helikon.png" /></a>
				</p>
			</nav>
			<div class="copyright">
				<div class="stats">
				...
				<p>© 1995–2013<br/>ОАО «ЦИМЛЯНСКИЕ ВИНА»</p>
				<p>При копировании материалов<br/>сайта ссылка на источник<br/>обязательна!</p>
				<p>Разработано агентством &mdash; &laquo;<a class="copy" href="http://grapheme.ru">Графема</a>&raquo;, 2012</p>
			</div>
		</section>
	</div>
</footer>